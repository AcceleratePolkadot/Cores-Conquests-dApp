...
const tabsTheme: CustomFlowbiteTheme["tabs"] = {
  tablist: {
    base: "flex text-center first:[&>button]:ml-10 space-x-3",
    tabitem: {
      ...
      variant: {
        default: {
          active: {
            ...
            off: "text-gray-500 bg-gray-50/50 hover:bg-gray-50 hover:text-gray-600 dark:text-gray-400 dark:bg-gray-700/20 dark:hover:bg-gray-800 dark:hover:text-gray-300",
          },
        },
      },
    },
